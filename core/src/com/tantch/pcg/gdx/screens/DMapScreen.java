...
import com.tantch.pcg.gdx.assets.GdxPlayer;
...
public class DMapScreen implements Screen {
	...
	private void drawMap() {
		...
		player.drawPlayer(game, pos);
		// draw attack
		game.batch.setColor(Settings.RGB[0], Settings.RGB[1], Settings.RGB[2], 1);
		game.batch.draw(blast, pos[0] * 2 + 2, pos[1] * 2 + 1, 1, 1);
